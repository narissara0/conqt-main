...
const PageOne = ({ onButtonClick }) => {
  ...
  const handleChange = (event)=>{
   ...
   data.filter(item=>event.target.value==item).map(item=>data.pop(item))
  }
  }
  ...
  return (
    <>
      <div className="popup-page1-header">
        <h1 className="popup-page1-title">Choose Your Company Industry</h1>
      </div>
      {error?<p className="err-message">Company Industry is required</p>:<></>}
      <div className="popup-page1-checkbox">
        ...
        <div className="checkbox-label">
          <input
            ...
            id="checkbox-input-5"
            type="checkbox"
            value="Finance Hospitality and Travel"
            onChange={(e)=>handleChange(e)}
          />
          <label className="checkbox-label-text" for="checkbox-input-5">
            Finance Hospitality and Travel
          </label>
        </div>
        <div className="checkbox-label">
          <input
      ...
      <div className="popup-page1-footer">
        <button className="page1-back-btn">
          <svg
            width="40"
            height="41"
            viewBox="0 0 40 41"
